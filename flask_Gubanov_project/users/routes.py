...
from flask_Gubanov_project import db, bcrypt
from flask_Gubanov_project.models import User, Post
from flask_Gubanov_project.users.forms import (RegistrationForm, LoginForm, UpdateAccountForm, RequestResetForm,
                                               ResetPasswordForm)

from flask_Gubanov_project.users.utils import save_picture, send_reset_email
...
def account():
    ...
    if form.validate_on_submit():
        if form.picture.data:
            picture_file = save_picture(form.picture.data, path_save='static/profile_pics')
